...
exports.securitySandbox = exports.CSPManager = exports.SecurityError = exports.SecuritySandbox = void 0;
class SecuritySandbox {
    static instance;
    executionCounts = new Map();
    violationLog = new Map();
    DEFAULT_POLICY = {
     ...
     */
    async executeSecure(fn, args = [], context, policy = {}) {
     ...
     */
    validateExecution(fn, context, policy) {
        // Check rate limiting
     ...
     */
    async executeInWebWorker(fn, args, policy) {
     ...
     */
    async executeInRestrictedContext(fn, args, policy) {
     ...
     */
    recordExecution(context, policy) {
     ...
     */
    recordViolationPublic(identifier) {
        this.recordViolation(identifier);
    }
    /**
...
class CSPManager {
    ...
    static generateCSP(allowNetworkAccess = false, allowedDomains = []) {
...
exports.securitySandbox = SecuritySandbox.getInstance();
