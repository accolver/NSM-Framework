...
export const WORD_LIST = [
  ...
  'BROWN', 'BUILD', 'BURNT', 'BUYER', 'CABLE', 'CALIF', 'CARRY', 'CATCH', 'CAUSE', 'CHAIN',
  ...
  'TASTE', 'TAXES', 'TEACH', 'TERRY', 'TEXAS', 'THANK', 'THEFT', 'THEIR', 'THERE', 'THESE',
